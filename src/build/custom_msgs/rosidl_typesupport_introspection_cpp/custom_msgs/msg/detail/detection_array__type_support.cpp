...
#include "custom_msgs/msg/detail/detection_array__struct.hpp"
...
{
  new (message_memory) custom_msgs::msg::DetectionArray(_init);
}

void DetectionArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::DetectionArray *>(message_memory);
...
{
  const auto & item = *reinterpret_cast<const custom_msgs::msg::Detection *>(
    get_const_function__DetectionArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<custom_msgs::msg::Detection *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<custom_msgs::msg::Detection *>(
    get_function__DetectionArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const custom_msgs::msg::Detection *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectionArray_message_member_array[2] = {
  {
    ...
    offsetof(custom_msgs::msg::DetectionArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::DetectionArray, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectionArray_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_msgs::msg::DetectionArray),
...
get_message_type_support_handle<custom_msgs::msg::DetectionArray>()
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::DetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, DetectionArray)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::DetectionArray_message_type_support_handle;
}
